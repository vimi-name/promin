...
The canonical alpha tree contains exactly 302 regular files under 17 declared
directories, including the nested `docs/audit` and `skills/example` packages.
`MANIFEST.json` enumerates the 300 payload files; `SHA256SUMS.txt` contains
301 checksums for the payload plus `MANIFEST.json`.
